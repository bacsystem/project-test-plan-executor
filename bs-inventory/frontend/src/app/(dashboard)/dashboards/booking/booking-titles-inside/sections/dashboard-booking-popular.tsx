...
export default function DashboardBookingPopular() {
  ...
  return (
    <Box>
      <Card className="flex h-89 p-0">
        <CardContent className="outline-background-paper from-background-paper to-primary-light/10 z-10 flex flex-1 flex-col items-start justify-between rounded-3xl bg-linear-to-r p-7! outline-4 -outline-offset-4 rtl:bg-linear-to-l">
