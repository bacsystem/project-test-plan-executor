...
export default function SupportOverviewCategories() {
  ...
  const handleCategoryClick = (event: any) => {
    ...
    router.push("/pages/support/issues");
  };
    ...
    <>
      ...
      <CardContent className="px-2! pt-0! pb-2!">
        <List dense>
          ...
          <ListItem disablePadding>
            <ListItemButton onClick={handleCategoryClick}>
              <ListItemText primary="Server response delays" className="ps-7" />
          ...
          <ListItem disablePadding>
            <ListItemButton onClick={handleCategoryClick}>
              <ListItemText primary="Unauthorized data access" className="ps-7" />
              <Chip label="10" variant="filled" className="text-sm" />
            </ListItemButton>
          </ListItem>
          <ListItem disablePadding>
            <ListItemButton onClick={handleCategoryClick}>
              <ListItemText primary="Cross-site scripting" className="ps-7" />
