        ...
        {headCells.map((headCell) => (
          ...
          >
            ...
            >
              {headCell.label}
              {orderBy === headCell.id ? (
                <Box component="span" className="pointer-events-none invisible h-0 w-0 overflow-hidden">
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
  ...
  return (
    <Toolbar className="min-h-0 p-0">
      <Box className="card-title flex w-full flex-row items-start justify-between">
          ...
          {numSelected > 0 ? (
            ...
            <Tooltip title="Filter list">
              <Button
                ...
                color="grey"
                variant="outlined"
                startIcon={<NiFilter size={"medium"} />}
              />
            </Tooltip>
          )}
        </Box>
...
export default function TableSortingSelecting() {
        ...
        <TableContainer>
          <Table className="w-full min-w-3xl">
            ...
            <TableBody>
              ...
              {Array.from({ length: emptyRows }).map((val, index) => {
                return (
                  <TableRow key={index}>
            ...
            select: {
              IconComponent: () => {
                return (
                  <NiChevronDownSmall
                    size="medium"
                    className="pointer-events-none absolute inset-e-1"
                  ></NiChevronDownSmall>
                );
              },
            },
