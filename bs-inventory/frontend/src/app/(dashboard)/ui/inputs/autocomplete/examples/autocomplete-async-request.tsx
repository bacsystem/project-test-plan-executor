...
export default function AutocompleteAsyncRequest() {
  ...
  const [optionsAsync, setOptionsAsync] = React.useState<readonly FilmOptionType[]>([]);
  const [loadingAsync, setLoadingAsync] = React.useState(false);
  const handleOpenAsync = () => {
    setOpenAsync(true);
    (async () => {
      ...
      <Card>
        <CardContent>
          ...
          <FormControl fullWidth>
            <FormLabel component="label">Async Request</FormLabel>
            <Autocomplete
              size="small"
