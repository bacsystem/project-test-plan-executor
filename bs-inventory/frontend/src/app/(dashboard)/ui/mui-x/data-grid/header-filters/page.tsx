"use client";
import HeaderFiltersBasic from "./examples/header-filters-basic";
import Link from "next/link";

import { Breadcrumbs, Card, CardContent, Typography } from "@mui/material";
import { Grid } from "@mui/material";

export default function HeaderFiltersPage() {
  return (
    <Grid container spacing={5}>
      <Grid size={12} className="mb-2">
        ...
        <Breadcrumbs>
          ...
          <Typography variant="body2">Header Filters</Typography>
        </Breadcrumbs>
      </Grid>
