...
const InputErrorTooltip = ({ title }: InputErrorProps) => {
  return (
    <Box className="relative z-10 w-full">
      <Tooltip title={title} arrow className="absolute inset-e-1 top-0.5">
        <Button
...
export default function FormikOutlined() {
        ...
        >
          ...
          <FormControl fullWidth>
            ...
            <Autocomplete
              ...
              clearIcon={<NiCross />}
              options={["10", "20", "30"]}
              renderInput={(params) => <TextField {...params} variant="outlined" label="Autocomplete" />}
